...
# best_fit <- barma(y, ar = c(1), ma = c(1), h = h,
#                   diag = 0, resid = 1, link = "logit")
# barma_model_order <- list(ar = c(1), ma = c(1))

# best_fit <- barma(y, ar = c(3), ma = c(1, 3, 4), h = h,
#                   diag = 0, resid = 1, link = "logit")
# barma_model_order <- list(ar = c(3), ma = c(1, 3, 4))

# best_fit <- barma(y, ar = c(2, 3, 4), ma = c(1, 2, 3), h = h,
#                   diag = 0, resid = 1, link = "logit")
# barma_model_order <- list(ar = c(2, 3, 4), ma = c(1, 2, 3))
...
png("In_sample_plot_2021.png", units = "in", width = 8, height = 4, res = 300)
...
ggplot(df_plot, aes(x = date_formatted)) +
  ...
  geom_line(aes(y = predicted), 
            ...
            size = 1.0) +
  labs(x = "\nData",
       y = "Razão de mortalidade materna 2021\n (mortes por 100.000 nascidos vivos)\n",
